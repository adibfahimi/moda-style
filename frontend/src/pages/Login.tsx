        ...
        <div class="card w-full max-w-md bg-base-100 shadow-2xl transition-all duration-300 hover:shadow-primary/10">
          <div class="card-body gap-6">
            ...
            <div class="space-y-2 text-center">
              ...
              <p class="text-base-content/60 text-sm">Welcome back! Please enter your details.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} class="space-y-4">
              ...
              <div class="form-control w-full">
                <div class="flex justify-between items-center pr-1">
                  ...
                  <A href="/forgot-password" class="text-xs link link-hover text-primary font-medium">Forgot password?</A>
                </div>
                <div class="relative">
                  <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-base-content/40">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p class="text-center text-sm text-base-content/60 mt-2">
              New to Moda Style?{' '}
              <A href="/register" class="link link-primary font-bold decoration-2 underline-offset-4">
                Create an account
              </A>
            </p>
          </div>
